...
const Footer = () => {
    return (
      <footer className="bg-[#0f1423] text-gray-400 py-16 px-6 font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-16">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="bg-white text-[#0f1423] w-8 h-8 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
                >
                  <FaInstagram />
                </a>
                <a
